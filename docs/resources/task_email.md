...
page_title: "stonebranch_task_email Resource - stonebranch"
subcategory: ""
description: |-
  Manages a StoneBranch Email Task. Email tasks send emails via configured email connections.
---
...
- `attach_local_file` (Boolean) Whether to attach a local file to the email.
- `bcc_recipients` (String) Comma-separated list of BCC recipients.
...
- `report_var` (String) Variable containing the report name to attach.
